...
import { ArrowLeft, FileText, Loader2, Save, Upload, X, Download } from "lucide-react";
		...
		return (
			<div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center">
				<div className="flex flex-col items-center gap-4">
					...
					<p className="text-muted-foreground text-lg">Loading circular data...</p>
				</div>
			</div>
		);
	}
					...
					<div className="flex-1 flex items-center gap-3">
						...
						<div>
							...
							<p className="text-muted-foreground mt-1.5 text-base">
								Update circular information (ID: {id})
							</p>
						</div>
					</div>
				</div>
					...
					<form onSubmit={handleSubmit}>
						<CardHeader className="pb-6 pt-8 px-8">
							...
							<CardDescription className="text-base">
								Update the fields below to modify this circular
							</CardDescription>
						</CardHeader>
