		...
		return (
			<div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center">
				<div className="flex flex-col items-center gap-4">
					...
					<p className="text-muted-foreground text-lg">Loading service category details...</p>
				</div>
			</div>
		);
	}
			...
			<div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center px-4">
				<Card className="max-w-md border-2 border-border/60 shadow-2xl shadow-primary/5 bg-card/50 backdrop-blur-sm">
					<CardContent className="pt-6 text-center space-y-4">
						...
						<p className="text-lg font-semibold text-foreground">Service category not found</p>
						...
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-muted-foreground mt-1.5 text-base">
									View service category information (ID: {id})
								</p>
							</div>
						</div>
					</div>
				...
				<Card className="border-2 border-border/60 shadow-2xl shadow-primary/5 bg-card/50 backdrop-blur-sm overflow-hidden">
					...
					<CardHeader className="pb-6 pt-8 px-8">
						...
						<CardDescription className="text-base">
							Detailed information about this service category
						</CardDescription>
					</CardHeader>
